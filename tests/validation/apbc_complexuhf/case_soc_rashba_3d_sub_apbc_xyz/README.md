...
`tests/validation/uhfk_mvmc_pairproduct/case_soc_rashba_3d_sub_apbc_xyz/`.
It uses `CellShape = [4, 4, 4]`, `SubShape = [2, 2, 2]`, `U = 2`,
`Ncond = 12`, and APBC in x, y, and z.
...
the phase mask `(180, 180, 180)` degrees. At runtime the harness replaces
