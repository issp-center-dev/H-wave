...
`tests/validation/uhfk_mvmc_pairproduct/case_soc_rashba_3d_sub_apbc_xz/`.
It uses `CellShape = [4, 4, 4]`, `SubShape = [2, 2, 2]`, `U = 2`,
`Ncond = 20`, and APBC in x and z.
...
the phase mask `(180, 0, 180)` degrees. At runtime the harness replaces
