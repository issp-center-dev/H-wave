...
`tests/validation/uhfk_mvmc_pairproduct/case_soc_rashba_3d_sub_apbc_yz/`.
It uses `CellShape = [4, 4, 4]`, `SubShape = [2, 2, 2]`, `U = 2`,
`Ncond = 24`, and APBC in y and z.
...
the phase mask `(0, 180, 180)` degrees. At runtime the harness replaces
