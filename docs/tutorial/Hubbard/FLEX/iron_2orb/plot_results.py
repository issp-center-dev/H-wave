...
def main():
    ...
    # calc_scheme 'auto' resolves to 'general' here (Exchange is present),
    # whose chiq_s/chiq_c come as the rank-4 orbital tensor [a, c, b, d];
    # sum the density sector (aa), (bb). The 4-dim branch keeps the script
    # usable with reduced-layout files.
    if chi_s.ndim == 6:
