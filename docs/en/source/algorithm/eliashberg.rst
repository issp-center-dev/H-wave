...
matching every other route in the package: declarations that contain both directions are
read unchanged, bit for bit. (Since issue #93 a one-sided declaration
