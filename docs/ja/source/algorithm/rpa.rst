...
判定基準が生の宣言ではなく組み立て後の頂点であることの帰結が2つあります。
対称化後の頂点で寄与が厳密に打ち消し合うオフサイト宣言の組は受理されます
（その場合チャネルが実際に使う頂点は well-defined です）。また ``SubShape``
による折り畳みでスーパーセル内に収まるサイト間ペアはセル内軌道ペアとなり、
表現可能として受理されます。縦方向（ ``ring`` ）チャネルは影響を受けません。
